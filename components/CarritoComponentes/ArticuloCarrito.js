...
const ArticuloCarrito = (props) => {
    ...
    const { artgen_nombre,artprov_descripcion,artprov_precio_compra, artprov_id_articulos_provedores,artgen_productImage,sum,artprov_id_supplier,surc_id_sucursales } = props.articulo;
                ...
                {/* <div className='cuadros'> */}
                    <div className='row'>
                        ...
                        <div className="col-8">
                            ...
                            {/* {props.children} */}
                            {React.cloneElement(props.children, {articulo:props.articulo })}
                        </div>
                    </div>
                </div>
        </div>
