...
const GuardarTransf = () => {
    ...
    const {cart,ObtenerTotales,CantidadTotal,GuardarIdCompra,GuardarTransferencia,totalItems} = comprasContext;
    ...
    const guardarIdCompra = id => {
        const sucursal_inicial = sucursal_seleccionada.id_sucursales
        const sucursal_final = sucursal_destino.id_sucursales
        ...
        GuardarTransferencia(articulos,sucursal_inicial,sucursal_final); // Fijar un producto
        }
    }
