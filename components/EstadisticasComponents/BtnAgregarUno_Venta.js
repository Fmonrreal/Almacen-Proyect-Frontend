...
const BtnAgregarUno_Venta = ({setArt,articulo}) => {
    ...
    return ( 
        <button 
            ...
            // onClick={()=>props.setArt(articulo.artprov_id_articulos_provedores)}>
            onClick={()=>setArt(articulo.artprov_id_articulos_provedores)}>
        Agregar
        </button>
     );
}
