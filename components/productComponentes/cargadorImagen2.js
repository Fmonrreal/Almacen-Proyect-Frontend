...
const CargadorImagen2 = (props) => {
    ...
    const funcionImage = async (fileUrl) => ( await props.setproductimage(fileUrl) );

    const imagenHandler = async (event) => {
...
export default CargadorImagen2;